...
if(isset($_SESSION["loggedin"]) && $_SESSION["loggedin"] === true){
    header("location: warehouse_profile.php");
    exit;
}
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($username_err) && empty($password_err)){
        ...
        $sql = "SELECT warehouse_id,mobile_no,warehouse_name,login_password FROM smfr_warehouse_registration WHERE mobile_no = ?";
        ...
        if($stmt = mysqli_prepare($link, $sql)){
            ...
            if(mysqli_stmt_execute($stmt)){
                ...
                if(mysqli_stmt_num_rows($stmt) == 1){                    
                    ...
                    mysqli_stmt_bind_result($stmt, $warehouse_id, $username, $warehouse_name,$hashed_password);
                    if(mysqli_stmt_fetch($stmt)){
                        if(password_verify($password, $hashed_password)){
                            ...
                            $_SESSION["id"] = $warehouse_id;
                            $_SESSION["username"] = $username; 
                            $_SESSION["warehouse_name"]=$warehouse_name;                    
...
<script type = "text/javascript">
            function Redirect() {
               window.location = "warehouse_register.php";
            }
</script> 
</head>
<body>
...
<div class="container">
<caption><h1><b><p style="color:white;"> Warehouse Login form</p></b></h1></caption>
<tr>
<th>Mobile No</th>
<td>
