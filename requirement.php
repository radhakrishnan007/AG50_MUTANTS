...
$sql = "SELECT * FROM warehouse_requirement";
...
<body>
    ...
    <div class="content_block">
        ...
        <div>
            <h1>Warehouse Product Requirements</h1> 
        ...
        <div>
        	<table border="1" cellpadding="10" cellspacing="10" style="width: 96%; margin-left:25px;margin-right:25px;margin-top: 25px;" id="customers">
        		<tr>
        			...
        			<th style="text-align: center;">Post On</th>
              ...
              <th style="text-align: center;">Qty</th>
			    ...
			    ?>
        		<tr>
        			<td><?php echo $product_row[$r]['post_id']?></td>
        			<td style="text-align: left;"><?php echo $product_row[$r]['warehouse_name']?></td>
        			<td><?php echo $product_row[$r]['requirement_title']?></td>
        			<td><?php echo $product_row[$r]['requirement_description']?></td>
        			<td><?php echo $product_row[$r]['post_date']?></td>        			
